...
rule Mirai_Botnet_ELF_Packed {
        ...
        condition:
               uint32(0) == 0x464C457F and filesize < 200KB and any of ($s*) and 2 of ($upx*)
}
...
rule Mirai_Botnet_ELF_Unpacked {
        ...
        strings:
                ...
                $s4 = "nickname"
                $s5 = { ?? ?? ?? ?? 3a 20 ?? ?? ?? 2e 32 35 35 2e 32 35 35 2e ?? ?? ?? 3a 31 39 30 30 } //UPNP Host Address.
                $s6 = { 51 51 6a ?? 50 } //Unique string.
                ...
                $variant15 = "killer.c"
                $variant16 = { 2F 62 69 6E 2F 63 ( 4F | 6F | 30 ) 6E 64 69 } //Condi botnet path.
                ...
                */
                ...
                $bytecode4 = { 4? 89 fa be 98 16 41 00 } //HTTP Header initializing, from the possible loader function.
        ...
        condition:
                uint32(0) == 0x464C457F and filesize < 350KB and (
                        ($s3 and $s4 and $s5) or ((1 of ($s1, $s2) and $s6) or 
                        any of ($bytecode*)) or any of ($variant*)
                )
}